...
- **当前阶段：** Phase 7（生产化）待规划。Phase 1–6 已交付；Phase 6 代码侧验收 27/28，真机 UAT 债务见 `06-HUMAN-UAT.md`。
- **已交付：** common/starter、48 Demo、knowledge-qa-platform（19100）、office-agent-assistant（19200）、smart-cs-platform（19300）、docker profiles、scripts、docs/tutorial/01–22。
- **父 POM `<modules>`：** 当前仅 common + starter；examples/* 与 projects/* 为独立应用，按阶段挂载。
- **已知欠账：** Phase 4/5/6 人工 UAT（需 infra + API Key）；Phase 6 code review Critical（会话→HITL/工单隔离）建议合入前修复；starter 单测可加强。
...
---
*Last updated: 2026-07-17 after Phase 6 (smart-cs-platform)*
