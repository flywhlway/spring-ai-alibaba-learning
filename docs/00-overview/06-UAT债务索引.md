...
| 4 | [`.planning/phases/04-knowledge-qa-platform/04-UAT.md`](../../.planning/phases/04-knowledge-qa-platform/04-UAT.md) | [`scripts/uat-knowledge-qa.sh`](../../scripts/uat-knowledge-qa.sh) | `19100` | **人工 UAT 债务**（需 Key + infra） |
| 5 | （无 `.planning/phases/05-*` UAT 文档，per RESEARCH A4） | [`projects/office-agent-assistant/scripts/uat-office-agent.sh`](../../projects/office-agent-assistant/scripts/uat-office-agent.sh) + [项目 README「测试」节](../../projects/office-agent-assistant/README.md) | `19200` | planning UAT 文档缺失；以脚本 / README 为准 |
| 6 | [`06-UAT.md`](../../.planning/phases/06-smart-cs-platform/06-UAT.md) + [`06-HUMAN-UAT.md`](../../.planning/phases/06-smart-cs-platform/06-HUMAN-UAT.md) | [`projects/smart-cs-platform/scripts/uat-smart-cs.sh`](../../projects/smart-cs-platform/scripts/uat-smart-cs.sh) | `19300` | **人工 UAT 债务**；HUMAN-UAT 结论勿在本索引改写 |
...
- Phase 6 code-review Critical（会话→HITL/工单隔离）见 `.planning/STATE.md` Pending（D-14，本阶段不修代码）
