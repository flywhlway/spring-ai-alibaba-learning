package com.flywhl.saa.knowledgeqa.support;
...
/**
 * Testcontainers 基座：PostgreSQL 16 + Redis 7，Milvus 由子类按需 Mock 或连接真机。
 *
 * @author flywhl
 */
@Testcontainers
@ExtendWith(DockerAvailableCondition.class)
public abstract class KqaPostgresRedisITBase {

  @Container
  static final PostgreSQLContainer<?> POSTGRES = new PostgreSQLContainer<>(
      DockerImageName.parse("postgres:16"))
      .withDatabaseName("kqa_platform")
      .withUsername("saa")
  ...
  static void registerProperties(DynamicPropertyRegistry registry) {
    ...
    registry.add("kqa.security.jwt.secret", () -> "dev-only-kqa-jwt-secret-key-32bytes!!");
  }
}
